...
# load video
video_path = 'X:\\Infosys_STMS\\Smart_Traffic_Management_System\\Data\\Video\\Traffic_05.mp4'
cap = cv2.VideoCapture(video_path)
...
out = cv2.VideoWriter('X:\\Infosys_STMS\\Smart_Traffic_Management_System\\Output\\Output_05.avi', fourcc, fps, (width, height))
